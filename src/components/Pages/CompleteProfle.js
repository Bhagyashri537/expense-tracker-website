...
const CompleteProfile = () => {
  ...
  const getSaveData = () => {
    let url =
      "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyCNgmjZ6lbRgU8TeM-YkpprB1uk9jhuNcg";
  ...
  const submitHandler = (e) => {
    ...
    let url =
      "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyCNgmjZ6lbRgU8TeM-YkpprB1uk9jhuNcg";
    fetch(url, {
      method: "POST",
      body: JSON.stringify({
        idToken: token,
          ...
          <div className="border-2 border-indigo-600 p-7 shadow-lg ">
            ...
            <div className="flex mt-5">
              ...
              <input
                ...
                className="border-2 border-rose-600 rounded-lg"
              />
              <img
                className="w-8 pl-4"
            ...
            <div className="pt-3">
              <button className="bg-pink-300 p-3 rounded-lg">Update</button>
            </div>
          </div>
        </form>
      </div>
